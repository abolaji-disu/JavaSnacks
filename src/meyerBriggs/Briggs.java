...
public class Briggs {
    ...
    static int[][] personaltyInput = new int[4][2];
    ...
    public static void printPersonalty(){
        ...
        if (personaltyInput[0][0] > personaltyInput[0][1]) { System.out.print("E");}
        else {System.out.print("I"); }

        if (personaltyInput[1][0] > personaltyInput[1][1]){System.out.print("S");}
        else {System.out.print("N");}

        if (personaltyInput[2][0] > personaltyInput[2][1]){System.out.print("T");}
        else{System.out.print("F");}

        if (personaltyInput[3][0] > personaltyInput[3][1]){System.out.print("J");}
